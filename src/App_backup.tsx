      ...
      <main className="flex-1 overflow-y-auto p-8">
        <header className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm">Welcome back, {user?.full_name || 'Guest'}</p>
          </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {user.role === 'student' && (
          <div className="flex items-center gap-2">
            ...
            <SendSmsButton to={user?.phone || '+251900000000'} studentName={user?.full_name || 'Student'} amount={5000} />
          </div>
        )}
      </div>
          ...
          <>
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h4 className="font-bold text-slate-900">{selectedUser?.full_name || 'User'}</h4>
              </div>
            </div>
